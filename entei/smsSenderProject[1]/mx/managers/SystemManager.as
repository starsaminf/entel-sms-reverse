package mx.managers
{
    ...
    public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager, ISWFBridgeProvider
    {
        ...
        function rawChildren_getObjectsUnderPoint(childList:Point) : Array
        {
            return super.getObjectsUnderPoint(childList);
        }// end function
        ...
        function findFocusManagerContainer(initFunction:SystemManagerProxy) : IFocusManagerContainer
        {
            var _loc_5:DisplayObject = null;
            var _loc_2:* = initFunction.rawChildren;
        ...
        override public function contains(sm:DisplayObject) : Boolean
        {
            var _loc_2:int = 0;
            var _loc_3:int = 0;
            var _loc_4:DisplayObject = null;
            if (super.contains(sm))
            {
                if (sm.parent == this)
                {
                    _loc_2 = super.getChildIndex(sm);
                ...
                else
                {
                    ...
                    while (_loc_3 < noTopMostIndex)
                    {
                        ...
                        {
                            if (IRawChildrenContainer(_loc_4).rawChildren.contains(sm))
                            {
                                return true;
                            }
                        }
                        ...
                        {
                            if (DisplayObjectContainer(_loc_4).contains(sm))
                            {
                                return true;
                            }
                        }
        ...
        public function getDefinitionByName(mx.managers:String) : Object
        {
            ...
            if (_loc_2.hasDefinition(mx.managers))
            {
                _loc_3 = _loc_2.getDefinition(mx.managers);
            }
            return _loc_3;
        }// end function
        ...
        override public function getChildAt(mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            return super.getChildAt(applicationIndex + mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        private function findLastActiveForm(mx.managers:Object) : Object
        {
            ...
            while (_loc_3 >= 0)
            {
                ...
                if (forms[_loc_3] != mx.managers && canActivatePopUp(forms[_loc_3]))
                {
                    return forms[_loc_3];
                }
                _loc_3 = _loc_3 - 1;
        ...
        private function preProcessModalWindowRequest(sm:SWFBridgeRequest, sm:DisplayObject) : Boolean
        {
            var _loc_3:IEventDispatcher = null;
            ...
            if (sm.data.skip)
            {
                ...
                if (useSWFBridge())
                {
                    _loc_3 = swfBridgeGroup.parentBridge;
                    sm.requestor = _loc_3;
                    _loc_3.dispatchEvent(sm);
                }
                return false;
            }
            if (sm != this)
            {
                if (sm.type == SWFBridgeRequest.CREATE_MODAL_WINDOW_REQUEST || sm.type == SWFBridgeRequest.SHOW_MODAL_WINDOW_REQUEST)
                {
                    _loc_4 = swfBridgeGroup.getChildBridgeProvider(sm.requestor) as ISWFLoader;
                    if (_loc_4)
                    {
                        _loc_5 = ISWFLoader(_loc_4).getVisibleApplicationRect();
                        sm.data.excludeRect = _loc_5;
                        if (!DisplayObjectContainer(document).contains(DisplayObject(_loc_4)))
                        {
                            sm.data.useExclude = false;
                        }
                    }
                }
                _loc_3 = swfBridgeGroup.parentBridge;
                sm.requestor = _loc_3;
                if (sm.type == SWFBridgeRequest.HIDE_MODAL_WINDOW_REQUEST)
                {
                    sm.dispatchEvent(sm);
                }
                else
        ...
        override public function getChildByName(mx.managers:SystemManager/private:isRemotePopUp:String) : DisplayObject
        {
            return super.getChildByName(mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        override public function addChildAt(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject, mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            var _loc_4:* = noTopMostIndex + 1;
            noTopMostIndex = _loc_4;
            return rawChildren_addChildAt(mx.managers:SystemManager/private:isRemotePopUp, applicationIndex + mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        private function findRemotePopUp(SystemManager:Object, SystemManager:IEventDispatcher) : RemotePopUp
        {
            ...
            while (_loc_4 < _loc_3)
            {
                ...
                if (isRemotePopUp(forms[_loc_4]))
                {
                    ...
                    if (_loc_5.window == SystemManager && _loc_5.bridge == SystemManager)
                    {
                        return _loc_5;
                    }
                }
        ...
        override public function removeChild(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject) : DisplayObject
        {
            var _loc_3:* = noTopMostIndex - 1;
            noTopMostIndex = _loc_3;
            return rawChildren_removeChild(mx.managers:SystemManager/private:isRemotePopUp);
        }// end function

        function rawChildren_removeChild(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject) : DisplayObject
        {
            removingChild(mx.managers:SystemManager/private:isRemotePopUp);
            super.removeChild(mx.managers:SystemManager/private:isRemotePopUp);
            childRemoved(mx.managers:SystemManager/private:isRemotePopUp);
            return mx.managers:SystemManager/private:isRemotePopUp;
        }// end function
        ...
        override public function addChild(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject) : DisplayObject
        {
            var _loc_3:* = noTopMostIndex + 1;
            noTopMostIndex = _loc_3;
            return rawChildren_addChildAt(mx.managers:SystemManager/private:isRemotePopUp, (noTopMostIndex - 1));
        }// end function
        ...
        override public function getChildIndex(ISystemManager:DisplayObject) : int
        {
            return super.getChildIndex(ISystemManager) - applicationIndex;
        }// end function

        function rawChildren_getChildIndex(ISystemManager:DisplayObject) : int
        {
            return super.getChildIndex(ISystemManager);
        }// end function
        ...
        function rawChildren_contains(sm:DisplayObject) : Boolean
        {
            return super.contains(sm);
        }// end function
        ...
        function rawChildren_getChildAt(mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            return super.getChildAt(mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        override public function getObjectsUnderPoint(childList:Point) : Array
        {
            var _loc_5:DisplayObject = null;
            ...
            while (_loc_4 < _loc_3)
            {
                ...
                {
                    _loc_6 = DisplayObjectContainer(_loc_5).getObjectsUnderPoint(childList);
                    if (_loc_6)
                    {
        ...
        public function isFontFaceEmbedded(sm:TextFormat) : Boolean
        {
            ...
            return !(sm.bold && !_loc_5.bold || sm.italic && !_loc_5.italic || !sm.bold && !sm.italic && !_loc_5.regular);
        }// end function

        private function forwardPlaceholderRequest(sm:SWFBridgeRequest, sm:Boolean) : Boolean
        {
            if (isTopLevelRoot())
            {
                return false;
            ...
            if (sm.data.window)
            {
                _loc_3 = sm.data.window;
                sm.data.window = null;
            }
            else
            {
                _loc_3 = sm.requestor;
                _loc_4 = sm.data.placeHolderId;
                sm.data.placeHolderId = NameUtil.displayObjectToString(this) + "." + sm.data.placeHolderId;
            }
            if (sm)
            {
                addPlaceholderId(sm.data.placeHolderId, _loc_4, sm.requestor, _loc_3);
            }
            else
            {
                removePlaceholderId(sm.data.placeHolderId);
            }
            ...
            if (_loc_5 == this)
            {
                _loc_6.dispatchEvent(sm);
            }
            else
            {
                _loc_5.dispatchEvent(sm);
            }
            return true;
        }// end function
        ...
        override public function removeChildAt(mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            var _loc_3:* = noTopMostIndex - 1;
            noTopMostIndex = _loc_3;
            return rawChildren_removeChildAt(applicationIndex + mx.managers:SystemManager/private:isRemotePopUp);
        }// end function

        function rawChildren_removeChildAt(mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            var _loc_2:* = super.getChildAt(mx.managers:SystemManager/private:isRemotePopUp);
            removingChild(_loc_2);
            super.removeChildAt(mx.managers:SystemManager/private:isRemotePopUp);
            childRemoved(_loc_2);
            return _loc_2;
        }// end function

        private function getSWFBridgeOfDisplayObject(SystemChildrenList:DisplayObject) : IEventDispatcher
        {
            var _loc_2:SWFBridgeRequest = null;
            ...
            if (swfBridgeGroup)
            {
                _loc_2 = new SWFBridgeRequest(SWFBridgeRequest.IS_BRIDGE_CHILD_REQUEST, false, false, null, SystemChildrenList);
                ...
                while (_loc_5 < _loc_4)
                {
                    ...
                    if (SecurityUtil.hasMutualTrustBetweenParentAndChild(_loc_7))
                    {
                        ...
                        _loc_2.data = SystemChildrenList;
                    }
                    _loc_5++;
                }
            }
        ...
        function rawChildren_getChildByName(mx.managers:SystemManager/private:isRemotePopUp:String) : DisplayObject
        {
            return super.getChildByName(mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        public function getVisibleApplicationRect(_document:Rectangle = null) : Rectangle
        {
            var _loc_2:Rectangle = null;
            ...
            if (!_document)
            {
                _document = getBounds(DisplayObject(this));
                _loc_2 = screen;
                _loc_3 = new Point(Math.max(0, _document.x), Math.max(0, _document.y));
                _loc_3 = localToGlobal(_loc_3);
                _document.x = _loc_3.x;
                _document.y = _loc_3.y;
                _document.width = _loc_2.width;
                _document.height = _loc_2.height;
            }
            if (useSWFBridge())
            {
                _loc_4 = swfBridgeGroup.parentBridge;
                _loc_5 = new SWFBridgeRequest(SWFBridgeRequest.GET_VISIBLE_RECT_REQUEST, false, false, _loc_4, _document);
                _loc_4.dispatchEvent(_loc_5);
                _document = Rectangle(_loc_5.data);
            }
            return _document;
        }// end function
        ...
        function rawChildren_addChildAt(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject, mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            addingChild(mx.managers:SystemManager/private:isRemotePopUp);
            super.addChildAt(mx.managers:SystemManager/private:isRemotePopUp, mx.managers:SystemManager/private:isRemotePopUp);
            childAdded(mx.managers:SystemManager/private:isRemotePopUp);
            return mx.managers:SystemManager/private:isRemotePopUp;
        }// end function
        ...
        final function $removeChildAt(mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            return super.removeChildAt(mx.managers:SystemManager/private:isRemotePopUp);
        }// end function

        private function canActivatePopUp(sm:Object) : Boolean
        {
            var _loc_2:RemotePopUp = null;
            var _loc_3:SWFBridgeRequest = null;
            if (isRemotePopUp(sm))
            {
                _loc_2 = RemotePopUp(sm);
            ...
            if (canActivateLocalComponent(sm))
            {
                return true;
            }
            return false;
        ...
        private function canActivateLocalComponent(sm:Object) : Boolean
        {
            if (sm is Sprite && sm is IUIComponent && Sprite(sm).visible && IUIComponent(sm).enabled)
            {
                return true;
            }
            return false;
        ...
        final function $addChildAt(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject, mx.managers:SystemManager/private:isRemotePopUp:int) : DisplayObject
        {
            return super.addChildAt(mx.managers:SystemManager/private:isRemotePopUp, mx.managers:SystemManager/private:isRemotePopUp);
        }// end function
        ...
        private function areFormsEqual(sm:Object, sm:Object) : Boolean
        {
            if (sm == sm)
            {
                return true;
            }
            if (sm is RemotePopUp && sm is RemotePopUp)
            {
                return areRemotePopUpsEqual(sm, sm);
            }
            return false;
        }// end function

        public function isTopLevelWindow(sm:DisplayObject) : Boolean
        {
            return sm is IUIComponent && IUIComponent(sm) == topLevelWindow;
        }// end function
        ...
        private function getTopLevelSystemManager(push:DisplayObject) : ISystemManager
        {
            var _loc_3:ISystemManager = null;
            var _loc_2:* = DisplayObjectContainer(push.root);
            if ((!_loc_2 || _loc_2 is Stage) && push is IUIComponent)
            {
                _loc_2 = DisplayObjectContainer(IUIComponent(push).systemManager);
            }
        ...
        public function isDisplayObjectInABridgedApplication(sm:DisplayObject) : Boolean
        {
            return getSWFBridgeOfDisplayObject(sm) != null;
        }// end function
        ...
        function rawChildren_addChild(mx.managers:SystemManager/private:isRemotePopUp:DisplayObject) : DisplayObject
        {
            addingChild(mx.managers:SystemManager/private:isRemotePopUp);
            super.addChild(mx.managers:SystemManager/private:isRemotePopUp);
            childAdded(mx.managers:SystemManager/private:isRemotePopUp);
            return mx.managers:SystemManager/private:isRemotePopUp;
        }// end function

        public static function getSWFRoot(mx.managers:SystemManager/private:isRemotePopUp:Object) : DisplayObject
        {
            var p:*;
            var sm:ISystemManager;
            var domain:ApplicationDomain;
            var cls:Class;
            var object:* = mx.managers:SystemManager/private:isRemotePopUp;
        ...
        private static function areRemotePopUpsEqual(sm:Object, sm:Object) : Boolean
        {
            if (!(sm is RemotePopUp))
            {
                return false;
            }
            if (!(sm is RemotePopUp))
            ...
            var _loc_3:* = RemotePopUp(sm);
            var _loc_4:* = RemotePopUp(sm);
        ...
        private static function getChildListIndex(ISystemManager:IChildList, ISystemManager:Object) : int
        {
            var childList:* = ISystemManager;
            var f:* = ISystemManager;
            var index:int;
            try
            {
        ...
        private static function isRemotePopUp(sm:Object) : Boolean
        {
            return !(sm is IFocusManagerContainer);
        }// end function

...
{
    import DownloadProgressBar.as$553.*;
    ...
    public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
    {
        ...
        protected function getPercentLoaded(39713:Number, 39713:Number) : Number
        {
            var _loc_3:Number = NaN;
            if (39713 == 0 || 39713 == 0 || isNaN(39713) || isNaN(39713))
            {
                return 0;
            }
            _loc_3 = 100 * 39713 / 39713;
        ...
        protected function set showLabel(MIN_WIDTH_INCHES:Boolean) : void
        {
            _showLabel = MIN_WIDTH_INCHES;
            draw();
            return;
        }// end function
        ...
        private function loadBackgroundImage(MIN_WIDTH_INCHES:Object) : void
        {
            var cls:Class;
            var newStyleObj:DisplayObject;
            var loader:Loader;
            var loaderContext:LoaderContext;
            var classOrString:* = MIN_WIDTH_INCHES;
        ...
        protected function set showPercentage(MIN_WIDTH_INCHES:Boolean) : void
        {
            _showPercentage = MIN_WIDTH_INCHES;
            draw();
            return;
        }// end function
        ...
        protected function showDisplayForDownloading(C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as:int, C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as:ProgressEvent) : Boolean
        {
            return C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as > 700 && C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as.bytesLoaded < C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as.bytesTotal / 2;
        }// end function
        ...
        protected function center(MIN_WIDTH_INCHES:Number, MIN_WIDTH_INCHES:Number) : void
        {
            _xOffset = Math.floor((MIN_WIDTH_INCHES - _borderRect.width) / 2);
            _yOffset = Math.floor((MIN_WIDTH_INCHES - _borderRect.height) / 2);
            return;
        }// end function
        ...
        protected function set downloadingLabel(MIN_WIDTH_INCHES:String) : void
        {
            _downloadingLabel = MIN_WIDTH_INCHES;
            return;
        }// end function
        ...
        public function set stageHeight(MIN_WIDTH_INCHES:Number) : void
        {
            _stageHeight = MIN_WIDTH_INCHES;
            return;
        }// end function
        ...
        public function set backgroundImage(MIN_WIDTH_INCHES:Object) : void
        {
            _backgroundImage = MIN_WIDTH_INCHES;
            return;
        }// end function

        private function calcX(39713:Number) : Number
        {
            return 39713 + _xOffset;
        }// end function

        private function calcY(39713:Number) : Number
        {
            return 39713 + _yOffset;
        }// end function

        public function set backgroundAlpha(MIN_WIDTH_INCHES:Number) : void
        {
            _backgroundAlpha = MIN_WIDTH_INCHES;
            return;
        }// end function
        ...
        public function set backgroundColor(MIN_WIDTH_INCHES:uint) : void
        {
            _backgroundColor = MIN_WIDTH_INCHES;
            return;
        }// end function

        private function initBackgroundImage(MIN_WIDTH_INCHES:DisplayObject) : void
        {
            var _loc_7:Number = NaN;
            var _loc_8:Number = NaN;
            var _loc_9:Number = NaN;
            addChildAt(MIN_WIDTH_INCHES, 0);
            var _loc_2:* = MIN_WIDTH_INCHES.width;
            var _loc_3:* = MIN_WIDTH_INCHES.height;
            ...
            MIN_WIDTH_INCHES.scaleX = _loc_7;
            MIN_WIDTH_INCHES.scaleY = _loc_8;
            var _loc_5:* = Math.round(0.5 * (stageWidth - _loc_2 * _loc_7));
            var _loc_6:* = Math.round(0.5 * (stageHeight - _loc_3 * _loc_8));
            MIN_WIDTH_INCHES.x = _loc_5;
            MIN_WIDTH_INCHES.y = _loc_6;
            if (!isNaN(backgroundAlpha))
            {
                MIN_WIDTH_INCHES.alpha = backgroundAlpha;
            }
            return;
        }// end function

        public function set backgroundSize(MIN_WIDTH_INCHES:String) : void
        {
            _backgroundSize = MIN_WIDTH_INCHES;
            return;
        }// end function

        protected function showDisplayForInit(C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as:int, C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as:int) : Boolean
        {
            return C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as > 300 && C:\autobuild\3.2.0\frameworks\projects\framework\src\mx\preloaders\DownloadProgressBar.as == 2;
        }// end function
        ...
        protected function setProgress(MIN_WIDTH_INCHES:Number, MIN_WIDTH_INCHES:Number) : void
        {
            if (!isNaN(MIN_WIDTH_INCHES) && !isNaN(MIN_WIDTH_INCHES) && MIN_WIDTH_INCHES >= 0 && MIN_WIDTH_INCHES > 0)
            {
                _value = Number(MIN_WIDTH_INCHES);
                _maximum = Number(MIN_WIDTH_INCHES);
                draw();
            }
            return;
        }// end function
        ...
        private function drawProgressBar(MIN_WIDTH_INCHES:Number) : void
        {
            ...
            var _loc_5:* = new Matrix();
            var _loc_6:* = _barRect.width * MIN_WIDTH_INCHES / 100;
            var _loc_7:* = _loc_6 / 2;
        ...
        public function set stageWidth(MIN_WIDTH_INCHES:Number) : void
        {
            _stageWidth = MIN_WIDTH_INCHES;
            return;
        }// end function
        ...
        protected function set label(MIN_WIDTH_INCHES:String) : void
        {
            if (!(MIN_WIDTH_INCHES is Function))
            {
                _label = MIN_WIDTH_INCHES;
            }
            draw();
            return;
        }// end function

        public function set preloader(MIN_WIDTH_INCHES:Sprite) : void
        {
            _preloader = MIN_WIDTH_INCHES;
            MIN_WIDTH_INCHES.addEventListener(ProgressEvent.PROGRESS, progressHandler);
            MIN_WIDTH_INCHES.addEventListener(Event.COMPLETE, completeHandler);
            MIN_WIDTH_INCHES.addEventListener(RSLEvent.RSL_PROGRESS, rslProgressHandler);
            MIN_WIDTH_INCHES.addEventListener(RSLEvent.RSL_COMPLETE, rslCompleteHandler);
            MIN_WIDTH_INCHES.addEventListener(RSLEvent.RSL_ERROR, rslErrorHandler);
            MIN_WIDTH_INCHES.addEventListener(FlexEvent.INIT_PROGRESS, initProgressHandler);
            MIN_WIDTH_INCHES.addEventListener(FlexEvent.INIT_COMPLETE, initCompleteHandler);
            return;
        }// end function
        ...
        override public function set visible(MIN_WIDTH_INCHES:Boolean) : void
        {
            if (!_visible && MIN_WIDTH_INCHES)
            {
                show();
            }
            else if (_visible && !MIN_WIDTH_INCHES)
            {
                hide();
            }
            _visible = MIN_WIDTH_INCHES;
            return;
        }// end function
        ...
        public static function set initializingLabel(MIN_WIDTH_INCHES:String) : void
        {
            _initializingLabel = MIN_WIDTH_INCHES;
            return;
        }// end function

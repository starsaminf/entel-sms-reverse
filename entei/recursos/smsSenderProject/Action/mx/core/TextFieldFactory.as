package mx.core
{
    ...
    public class TextFieldFactory extends Object implements ITextFieldFactory
    {
        ...
        public function createTextField(instance:IFlexModuleFactory) : TextField
        {
            var _loc_4:Object = null;
            var _loc_2:TextField = null;
            var _loc_3:* = textFields[instance];
            if (_loc_3)
            {
            ...
            if (!_loc_2)
            {
                if (instance)
                {
                    _loc_2 = TextField(instance.create("flash.text.TextField"));
                }
                else
                {

package mx.core
{
    ...
    public class FlexVersion extends Object
    {
        ...
        static function changeCompatibilityVersionString(versionAlreadyRead:String) : void
        {
            var _loc_2:* = versionAlreadyRead.split(".");
        ...
        public static function set compatibilityVersion(versionAlreadyRead:uint) : void
        {
            var _loc_2:String = null;
            if (versionAlreadyRead == _compatibilityVersion)
            {
                return;
            }
            if (compatibilityVersionChanged)
            {
                ...
                compatibilityErrorFunction(versionAlreadyRead, VERSION_ALREADY_SET);
            }
            if (compatibilityVersionRead)
            {
                ...
                compatibilityErrorFunction(versionAlreadyRead, VERSION_ALREADY_READ);
            }
            _compatibilityVersion = versionAlreadyRead;
        ...
        public static function set compatibilityErrorFunction(versionAlreadyRead:Function) : void
        {
            _compatibilityErrorFunction = versionAlreadyRead;
            return;
        }// end function

        public static function set compatibilityVersionString(versionAlreadyRead:String) : void
        {
            var _loc_2:* = versionAlreadyRead.split(".");
            var _loc_3:* = parseInt(_loc_2[0]);
            var _loc_4:* = parseInt(_loc_2[1]);
